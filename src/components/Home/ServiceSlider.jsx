    ...
    return (
        <div>
            <div className=" serv_slider_paren w-full center mt-20 text-[#FFFDF6] h-screen relative">
                <img className=' serv_slide_bg_img_1 w-full h-full absolute object-cover top-0 left-0 z-[4] ' src="/images/HomePage/serviceSlider/serviceImg1.webp" alt="" />
                <img className=' serv_slide_bg_img_2 w-full h-full absolute object-cover top-0 left-0 z-[3] ' src="/images/HomePage/serviceSlider/serviceImg2.webp" alt="" />
                <img className=' serv_slide_bg_img_3 w-full h-full absolute object-cover top-0 left-0 z-[2] ' src="/images/HomePage/serviceSlider/serviceImg3.webp" alt="" />
                <img className=' serv_slide_bg_img_4 w-full h-full absolute object-cover top-0 left-0 z-[1] ' src="/images/HomePage/serviceSlider/serviceImg4.webp" alt="" />
                ...
                <div className=" serv_slide_bg_img_1 absolute w-[90%] h-[85%] bg-[#454738] z-[15] p-8">
                    ...
                    <div className="h-[60%] w-full">
                        <img className='w-full h-full object-cover ' src="/images/HomePage/serviceSlider/serviceImg1.webp" alt="" />
                    </div>
                </div>
                ...
                <div className=" serv_slide_bg_img_2 absolute w-[90%] h-[85%] bg-[#454738] z-[14] p-8">
                    ...
                    <div className="h-[60%] w-full">
                        <img className='w-full h-full object-cover ' src="/images/HomePage/serviceSlider/serviceImg2.webp" alt="" />
                    </div>
                </div>
                ...
                <div className="serv_slide_bg_img_3 absolute w-[90%] h-[85%] bg-[#454738] z-[13] p-8">
                    ...
                    <div className="h-[60%] w-full">
                        <img className='w-full h-full object-cover ' src="/images/HomePage/serviceSlider/serviceImg3.webp" alt="" />
                    </div>
                </div>
                ...
                <div className="serv_slide_bg_img_4 absolute w-[90%] h-[85%] bg-[#454738] z-[12] p-8">
                    ...
                    <div className="h-[60%] w-full">
                        <img className='w-full h-full object-cover ' src="/images/HomePage/serviceSlider/serviceImg4.webp" alt="" />
                    </div>
