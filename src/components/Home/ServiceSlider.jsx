    ...
    return (
        <div>
            <div className=" serv_slider_paren w-full center mt-20 text-[#FFFDF6] h-screen relative">
                <img className=' serv_slide_bg_img_1 w-full h-full absolute object-cover top-0 left-0 z-[4] ' src="/Images/HomePage/FooterImg.webp" alt="" />
                ...
                <div className=" serv_slide_bg_img_1 absolute w-[90%] h-[85%] bg-[#454738] z-[15] p-8">
                    ...
                    <div className="h-[60%] w-full">
                        <img className='w-full h-full object-cover ' src="/Images/HomePage/FooterImg.webp" alt="" />
                    </div>
                </div>
